        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><!--<img src="images/avatar/48.jpg" alt="" class="img-responsive img-circle"/>-->&nbsp;<span class="hidden-xs"><?php echo $_SESSION['ADMIN_NAME'] ?></span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            ...
                            <li><a href="<?php echo site_url('Admin/logout'); ?>"><i class="fa fa-key"></i>Log Out</a></li>
                        </ul>
                    </li>
